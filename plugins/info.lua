...
#
# author: Ashi < @ashi_king_kaboos > 
# our channel: not channel
# Version: 2016-04-02
#
# Features added:
# -- setrank on reply
...
do
local ashi = 81444630 --put your id here(BOT OWNER ID)
...
local function res_user_callback(extra, success, result) -- /info <username> function
  ...
  if result.username then
   ...
   Username = 'ندارد'
    ...
    if not value then
	 if result.id == tonumber (ashi) then
